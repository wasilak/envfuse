...
- [x] **SECU-01**: Runtime never logs secret values in stdout/stderr or structured logs
...
- [x] **OBSV-01**: Operator can observe sync success/failure, cycle latency, and restart reason
